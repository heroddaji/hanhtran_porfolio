document.addEventListener("DOMContentLoaded", function () {
  ...
  const content = {
    vi: {
      name: "Hạnh Trần",
      title:
        "Chuyên viên Tài chính Cao cấp tại Tập đoàn Đầu tư Challenger Group Ltd, Australia<br>Anaplan Certified Solution Architect & Model Builder<br>Microsoft Office Specialist - Excel Expert<br>Ứng viên CFA Level II<br>Thạc sĩ Kinh Doanh Quốc Tế",
      aboutTitle: "Về tôi",
      aboutText:
    ...
    en: {
      name: "Hanh Tran",
      title:
        "Senior Financial Analyst at Challenger Group Ltd<br>Anaplan Certified Solution Architect & Model Builder<br>Microsoft Office Specialist - Excel Expert<br>CFA Level II Candidate<br>Master of Arts in International Business",
      aboutTitle: "About Me",
      aboutText:
